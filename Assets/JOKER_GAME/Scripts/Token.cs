...
public class Token : MonoBehaviour {
	...
	{
		get { Vector2 v = _rigidbody2D.velocity; return Mathf.Atan2(v.y, v.x) * Mathf.Rad2Deg; }
	}
	/// 速度
	public float Speed
	{
		get { Vector2 v = _rigidbody2D.velocity; return Mathf.Sqrt(v.x*v.x + v.y*v.y); }
	}
	/// 重力
  ...
  public bool BoxColliderEnabled {
    ...
    // GameObjectのレイヤーを設定する
    public void SetGameObjectLayer(int a_layer)
    {
        gameObject.layer = a_layer;
    }
